...
public class CharacterConfirmationController {
    ...
    public void continueToUserSelect(ActionEvent event){
        try{
            // Moves to the UserSelect scene and sends the username and character
            FXMLLoader loader = new FXMLLoader(getClass().getResource("UserSelect.fxml"));
            root = loader.load();
            UserSelectController userSelectController = loader.getController();
            userSelectController.defineUser(userCharacter, username);
